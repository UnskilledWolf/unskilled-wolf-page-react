                ...
                <Row>
                    <Col>
                        ...
                        <Section href="/websites" title="Web Design" image={require("../../assets/index_code.png")}>
                            I design websites, currently know how to make front end sites with React and how to create back end thigs with NodeJS and express. I'm currently working on Authentication and Security
                        </Section>
                        <Section href="/games" title="Games" image={require("../../assets/index_games.png")}>
                            I create Video Games, although I have ben focusing on websites for a while. I mainly make very small and simple games, and just some experiments with different engines, like Processing and Unity3D.
                        </Section>
                    </Col>
                </Row>
            </Container>
