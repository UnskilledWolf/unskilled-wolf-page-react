    ...
    return (
        <div id="Home">
            ...
            <div className="main-articles">
                <Article image={require("../assets/art.svg").default} title="Art" id="art">
                    ...
                    <Link to="/gallery" className="button-link">Art Gallery</Link><br />
                    You can see my art on my <a href="https://deviantart.com/hexagonal192">DeviantArt</a>
                </Article>

                <Article image={require("../assets/sites.svg").default} title="Websites" id="websites">
                ...
                <Article image={require("../assets/games.svg").default} title="Code" id="code">
